...
/**
 * The class <code>BNFPrinter</code> extends the 
 ...
 */
public class BNFPrinter extends DefaultReporter {
	...
	public Object report(Argument[] args, Context context) throws ExtensionException, LogoException {
		...
		String reference = args[0].getString();   

		// Get the BNF Grammar
		BNFGrammar bnf = BNFLoader.get(reference);
		if (bnf == null) throw new ExtensionException("There is no BNF Grammar in memory referenced by \"" + reference + "\"");
