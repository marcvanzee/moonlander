...
/**
 * The class <code>Population</code> extends the 
 ...
 */
public class Population extends DefaultReporter {
	...
	public Syntax getSyntax() {       
        ...
        return Syntax.reporterSyntax(new int[] {Syntax.TYPE_NUMBER, Syntax.TYPE_NUMBER, Syntax.TYPE_NUMBER, Syntax.TYPE_NUMBER}, Syntax.TYPE_LIST);
	...
	public Object report(Argument[] args, Context context) throws ExtensionException, LogoException {
        ...
        int codonlength = args[1].getIntValue();
        int min = args[2].getIntValue();
        int max = args[3].getIntValue();
        
        // Check Arguments
        if (size <= 0) throw new ExtensionException("Size value must be greater than zero (0)");
        ...
        // Create a NetLogo List fill it with the generated population
        LogoList list = new LogoList();
        for (int i = 0; i < size; i++)
        	list.add(i, population[i]);       
